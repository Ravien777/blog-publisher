  ...
  section.innerHTML = `
    ...
    <div class="form-group">
      <label style="display:none;align-items:center;gap:8px;cursor:pointer;">
        <input type="checkbox" id="brandingToggle" checked> Apply Site Branding
      </label>
        ...
        if (currentEditingType === "page") {
          payload.meta = {
            ...
            _full_width_page: document.getElementById("fullWidthToggle")
              ...
              ? 1
              : 0,
            _apply_branding: true,
            _branding_primary_color: brandingColorEl?.value || "#7272ff",
            _body_class: "wp-post-manager", // Add a custom body class for targeted styling
          };
        }
